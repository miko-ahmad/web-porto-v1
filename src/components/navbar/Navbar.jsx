...
export default function Navbar({ toggleMode, darkMode }) {
  return (
    <nav
      className="fixed bottom-0 left-0 w-full xl:dark:bg-darkOne xl:bg-light shadow-lg bg-opacity-50 backdrop-blur-[10px] border border-darkFive rounded-t-[12px] z-[50] 
